...
function loadData() {  
  ...
  skills = {
    trickster: [
      ...
      /* 4  */ [ 0, [ 2, 3, 6, 7, 25 ], [ 2, 3, 5, 6, 7, 25 ], "Death Probability", { "Weapon Schaden": 0.08 } ],
      /* 5  */ [ 0, [ 4 ], [], "Shotgun Master", { "Weapon Schaden (Shotgun)": 0.15, "Drop Rate (Shotgun)": 0.2 } ],
      /* 6  */ [ 0, [ 4, 8 ], [ 4, 8 ], "Equlibrium", { "Skill Cooldown (Movement)": 0.15 } ],
      /* 7  */ [ 0, [ 4, 8 ], [ 4, 8 ], "Deadly Shadow", { "Crit Schaden": 0.2 } ],
      /* 8  */ [ 0, [ 6, 7, 28 ], [ 6, 7, 9, 10, 11, 28 ], "Arms Trick", { "Weapon Schaden (Close Range)": 0.15 } ],
      /* 9  */ [ 0, [ 8 ], [], "Distruptive Firepower", { "Activating a Deception Skill increases Weapon Schaden by 35% for 8s": null } ],
      /* 10 */ [ 0, [ 8 ], [ 12 ], "Singularity", { "Skill Cooldown (Deception)": 0.15 } ],
      /* 11 */ [ 0, [ 8 ], [ 12 ], "Ace of Trumps", { "Armor Piercing": 0.1 } ],
      /* 12 */ [ 0, [ 10, 11 ], [ 13, 14, 15 ], "Unforseen End", { "Weapon Schaden (From Behind)": 0.2 } ],
      /* 13 */ [ 0, [ 12 ], [], "Scion of the Power", { "When your Schaden Skill ends, increase Weapon Schaden by 35% for 8s": null } ],
      /* 14 */ [ 0, [ 12 ], [ 16 ], "Death Probability", { "Weapon Schaden": 0.08 } ],
      /* 15 */ [ 0, [ 12 ], [ 16 ], "Arms Trick", { "Weapon Schaden (Close Range)": 0.15 } ],
      /* 16 */ [ 0, [ 14, 15 ], [ 17, 19 ], "Death Probability", { "Weapon Schaden": 0.08 } ],
      /* 17 */ [ 0, [ 16 ], [ 18 ], "Equlibrium", { "Skill Cooldown (Movement)": 0.15 } ],
      /* 18 */ [ 0, [ 17 ], [], "Transfusion", { "Weapon Leech": 0.05 } ],
      /* 19 */ [ 0, [ 16 ], [ 20, 21 ], "Unforseen End", { "Weapon Schaden (From Behind)": 0.2 } ],
      /* 20 */ [ 0, [ 19 ], [], "Bounty Hunter", { "Weapon Schaden (Against Elites)": 0.15 } ],
      /* 21 */ [ 0, [ 19 ], [ 22, 23 ], "Oddity Summation", { "Magazine Size": 0.5 } ],
      /* 22 */ [ 0, [ 21 ], [ 24 ], "Assault Adept", { "Weapon Schaden (Assault)": 0.12 } ],
      /* 23 */ [ 0, [ 21 ], [ 24 ], "Shotgun Adept", { "Weapon Schaden (Shotgun)": 0.12 } ],
      /* 24 */ [ 0, [ 22, 23 ], [], "Cold Calculation", { "For each Enemy in Close Range, your Weapon Schaden is increased by 8%": null } ],
      
      /* 25 */ [ 0, [ 4, 26 ], [ 4, 26 ], "Arms Trick", { "Weapon Schaden (Close Range)": 0.15 } ],
      ...
      /* 28 */ [ 0, [ 8, 36 ], [ 8, 29, 36 ], "Outrider Executioner", { "Activating a Movement Skill increases Weapon Schaden by 35% for 8s": null } ],
      /* 29 */ [ 0, [ 28 ], [], "Ace of Trumps", { "Armor Piercing": 0.1 } ],
      
      /* 30 */ [ 0, [ 0, 31, 32 ], [ 31, 32 ], "Anomaly Presistence", { "Leben": 0.1 } ],
      /* 31 */ [ 0, [ 30, 33 ], [ 30, 33 ], "Immunity", { "Resistance": 0.15 } ],
      /* 32 */ [ 0, [ 30, 33 ], [ 30, 33 ], "Oddity Resistance", { "Schaden Taken (From Elites)": -0.2 } ],
      /* 33 */ [ 0, [ 26, 31, 32, 34, 35, 50 ], [ 26, 31, 32, 34, 35, 50 ], "Anomaly Presistence", { "Leben": 0.1 } ],
      /* 34 */ [ 0, [ 33, 36 ], [ 33, 36 ], "Shield's Timeline", { "Shield Degradation": -0.3 } ],
      /* 35 */ [ 0, [ 33, 36 ], [ 33, 36 ], "Atrophy", { "Weakness Duration": 0.3 } ],
      /* 36 */ [ 0, [ 28, 34, 35, 53 ], [ 28, 34, 35, 37, 38, 53 ], "Anomaly Presistence", { "Leben": 0.1 } ],
      ...
      /* 40 */ [ 0, [ 39 ], [], "Mitigation in Motion", { "When your Schaden Skill ends, increase Schaden Mitigation by 10% for 10s": null } ],
      ...
      /* 47 */ [ 0, [ 46 ], [ 49 ], "Dualshield", { "Schaden Mitigation while Shield is active": 0.06 } ],
      /* 48 */ [ 0, [ 46 ], [ 49 ], "Anomaly Cloak", { "Armor": 0.2 } ],
      /* 49 */ [ 0, [ 47, 48 ], [], "Distruption Shield", { "Activating a Deception Skill grants you 20% Shield": null } ],
      
      /* 50 */ [ 0, [ 33, 52 ], [ 33, 51, 52 ], "Against the Odds", { "When surrounded by Enemies, reloading your weapon deals Schaden and interrupts enemies' abilities. Schaden scales with Anomaly Power": null } ],
      ...
      /* 59 */ [ 0, [ 58 ], [], "Assault Master", { "Increase Assault Schaden by 3.5% for each unlocked Concentration node": null, "Drop Rate (Assault)": 0.2 } ],
      /* 60 */ [ 0, [ 58, 62 ], [ 58, 62 ], "Concentration", { "Anomaly Power": 0.06 } ],
      /* 61 */ [ 0, [ 58, 62 ], [ 58, 62 ], "Continuum", { "Skill Cooldown (Schaden)": 0.15 } ],
      ...
      /* 71 */ [ 0, [ 70 ], [ 72 ], "Continuum", { "Skill Cooldown (Schaden)": 0.15 } ],
      /* 72 */ [ 0, [ 71 ], [], "Anomalic Acceleration", { "When your Schaden Skill ends, increase Anomaly Power by 50% for 10s": null } ],
      ...
      /* 75 */ [ 0, [ 73 ], [ 76, 77 ], "Scion of the Void", { "When your Schaden Skill ends, increase Armor Piercing by 30% and Resistance Piercing by 25% for 10s": null } ],
      /* 76 */ [ 0, [ 75 ], [ 78 ], "Shadow's Embrace", { "Increase Firepower by 15% of your Anomaly Power": null } ],
      /* 77 */ [ 0, [ 75 ], [ 78 ], "Schild Hoch", { "[heilungsmechanik] Gegner, die innerhalb kurzer Distanz sterben, heilen dich nicht mehr um 20 % deines maximalen Lebens, stattdessen wird zusätzlich 20 % Shield generiert.": null } ],
    ...
    pyromant: [
       ...
       /* 1  */ [ 0, [ 0, 2, 3 ], [ 2, 3 ], "Inferno Weapon", { "Weapon Schaden": 0.08 } ],
       /* 2  */ [ 0, [ 1, 4 ], [ 1, 4 ], "Moths to the Flame", { "Weapon Leech": 0.05 } ],
       /* 3  */ [ 0, [ 1, 4 ], [ 1, 4 ], "Marble Orchard", { "Skill Cooldown (Immobilize)": 0.15 } ],
       /* 4  */ [ 0, [ 2, 3, 6, 7, 25 ], [ 2, 3, 5, 6, 7, 25 ], "Mark of the Anomaly", { "Weapon Schaden (Against Marked)": 0.1 } ],
       /* 5  */ [ 0, [ 4 ], [], "Assault Master", { "Weapon Schaden (Assault)": 0.2, "Drop Rate (Assault)": 0.2 } ],
       /* 6  */ [ 0, [ 4, 8 ], [ 4, 8 ], "Blood Boil", { "Armor Piercing": 0.1 } ],
       /* 7  */ [ 0, [ 4, 8 ], [ 4, 8 ], "Trial of the Ashes", { "Schaden (Against Ashed)": 0.1 } ],
       /* 8  */ [ 0, [ 6, 7, 28 ], [ 6, 7, 9, 10, 11, 28 ], "Mark of the Anomaly", { "Weapon Schaden (Against Marked)": 0.1 } ],
       ...
       /* 12 */ [ 0, [ 10, 11 ], [ 13, 14, 15 ], "Mark of the Anomaly", { "Weapon Schaden (Against Marked)": 0.1 } ],
       /* 13 */ [ 0, [ 12 ], [], "Sniper Master", { "Weapon Schaden (Sniper)": 0.2, "Drop Rate (Sniper)": 0.2 } ],
       /* 14 */ [ 0, [ 12 ], [ 16 ], "Blood Boil", { "Armor Piercing": 0.1 } ],
       /* 15 */ [ 0, [ 12 ], [ 16 ], "Inferno Weapon", { "Weapon Schaden": 0.08 } ],
       /* 16 */ [ 0, [ 14, 15 ], [ 17, 19, 20 ], "Mark of the Anomaly", { "Weapon Schaden (Against Marked)": 0.1 } ],
       ...
       /* 21 */ [ 0, [ 20 ], [ 22, 23 ], "...Hurt Twice as Long", { "Schaden (Against Elites)": 0.1, "Schaden Taken (From Elites)": -0.1 } ],
       /* 22 */ [ 0, [ 21 ], [ 24 ], "Trial of the Ashes", { "Schaden (Against Ashed)": 0.15 } ],
       /* 23 */ [ 0, [ 21 ], [ 24 ], "Marble Orchard", { "Skill Cooldown (Immobilize)": 0.15 } ],
       /* 24 */ [ 0, [ 22, 23 ], [], "Burning Situation", { "Activating an Immobilize Skill increases Weapon Schaden by 45% for 10s": null } ],
      
       /* 25 */ [ 0, [ 4, 26 ], [ 4, 26 ], "Sidearm Adept", { "Weapon Schaden (Sidearm)": 0.12 } ],
       ...
       /* 30 */ [ 0, [ 0, 31, 32 ], [ 31, 32 ], "Magma Golem", { "Leben": 0.1 } ],
       /* 31 */ [ 0, [ 30, 33 ], [ 30, 33 ], "Unquenchable", { "Skill Leech": 0.06 } ],
       /* 32 */ [ 0, [ 30, 33 ], [ 30, 33 ], "Warm Up", { "Skill Cooldown (Ignite)": 0.15 } ],
       /* 33 */ [ 0, [ 26, 31, 32, 34, 35, 51 ], [ 26, 31, 32, 34, 35, 51 ], "Magma Golem", { "Leben": 0.1 } ],
       /* 34 */ [ 0, [ 33, 36 ], [ 33, 36 ], "Master of the Armor", { "Armor": 0.2 } ],
       /* 35 */ [ 0, [ 33, 36 ], [ 33, 36 ], "Meltdown", { "Burn Schaden": 0.2 } ],
       /* 36 */ [ 0, [ 28, 34, 35, 54 ], [ 28, 34, 35, 37, 38, 54 ], "Magma Golem", { "Leben": 0.1 } ],
       /* 37 */ [ 0, [ 36 ], [ 39 ], "Gifted", { "Weapon Schaden": 0.05, "Anomaly Power": 0.05 } ],
       /* 38 */ [ 0, [ 36 ], [ 39 ], "Master of the Resistance", { "Resistance": 0.2 } ],
       /* 39 */ [ 0, [ 37, 38 ], [ 40, 41, 42, 43 ], "Magma Golem", { "Leben": 0.1 } ],
       /* 40 */ [ 0, [ 39 ], [], "Distant Flame", { "Increase Anomaly Power by 2.5% for each unlocked Magma Golem node": null } ],
       /* 41 */ [ 0, [ 39 ], [], "All Guns Blazing", { "Activating Any Skill increases Weapon Schaden by 20% for 7s": null } ],
       /* 42 */ [ 0, [ 39 ], [ 44 ], "Unquenchable", { "Skill Leech": 0.06 } ],
       /* 43 */ [ 0, [ 39 ], [ 44 ], "Let Them Burn", { "Burn Duration": 0.2 } ],
       /* 44 */ [ 0, [ 42, 43 ], [ 45 ], "Magma Golem", { "Leben": 0.1 } ],
       ...
       /* 47 */ [ 0, [ 45 ], [ 48, 49 ], "Fuel for the Embers", { "Skill Leech is doubled when below 30% Leben": null } ],
       /* 48 */ [ 0, [ 47 ], [ 50 ], "Trail by Fire", { "Schaden (Against Burning)": 0.15 } ],
       ...
       /* 52 */ [ 0, [ 51 ], [], "Trail by Fire", { "Schaden (Against Burning)": 0.05 } ],
       /* 53 */ [ 0, [ 51, 59 ], [ 51, 59 ], "Gifted", { "Weapon Schaden": 0.05, "Anomaly Power": 0.05 } ],
       /* 54 */ [ 0, [ 36, 63 ], [ 36, 55, 63 ], "Extinction", { "Increase Schaden by 20% against Enemies below 30% Leben": null } ],
       /* 55 */ [ 0, [ 54 ], [], "Let Them Burn", { "Burn Duration": 0.2 } ],
      
       /* 56 */ [ 0, [ 0, 57, 58 ], [ 57, 58 ], "Archeilungsmechanikage", { "Anomaly Power": 0.06 } ],
       /* 57 */ [ 0, [ 56, 59 ], [ 56, 59 ], "Mark's Cumulation", { "Skill Schaden (Against Marked)": 0.08 } ],
       ...
       /* 60 */ [ 0, [ 59 ], [], "With Fire and Rifle", { "Activating an Explosive Skill increases Weapon Schaden by 35% for 10s": null } ],
       /* 61 */ [ 0, [ 59, 63 ], [ 59, 63 ], "Mark's Cumulation", { "Skill Schaden (Against Marked)": 0.08 } ],
       /* 62 */ [ 0, [ 59, 63 ], [ 59, 63 ], "Strength of the Flame", { "Schaden Taken (From Elites)": -0.1 } ],
       ...
       /* 65 */ [ 0, [ 63 ], [ 67 ], "Meltdown", { "Burn Schaden": 0.2 } ],
       /* 66 */ [ 0, [ 63 ], [ 67 ], "Gifted", { "Weapon Schaden": 0.05, "Anomaly Power": 0.05 } ],
       ...
       /* 76 */ [ 0, [ 74 ], [ 77, 78 ], "Flames that Burn Twice...", { "Schaden (Against Elites)": 0.1 } ],
       /* 77 */ [ 0, [ 76 ], [ 79 ], "Mark's Cumulation", { "Skill Schaden (Against Marked)": 0.08 } ],
       /* 78 */ [ 0, [ 76 ], [ 79 ], "World Ablaze", { "Skill Cooldown (Explosive)": 0.15 } ],
       /* 79 */ [ 0, [ 77, 78 ], [], "Grave Ablaze", { "Skill Schaden (Explosive)": 0.3 } ]
    ],
    ...
    verwüster: [
       ...
       /* 1  */ [ 0, [ 0, 2, 3 ], [ 2, 3 ], "Havoc", { "Weapon Schaden": 0.08 } ],
       /* 2  */ [ 0, [ 1, 4 ], [ 1, 4 ], "Shotgun Adept", { "Weapon Schaden (Shotgun)": 0.12 } ],
       /* 3  */ [ 0, [ 1, 4 ], [ 1, 4 ], "Armorbreaker", { "Armor Piercing": 0.1 } ],
       /* 4  */ [ 0, [ 2, 3, 6, 7, 25 ], [ 2, 3, 5, 6, 7, 25 ], "Brawler", { "Weapon Schaden (Close Range)": 0.15 } ],
       /* 5  */ [ 0, [ 4 ], [], "Shotgun Master", { "Weapon Schaden (Shotgun)": 0.15, "Drop Rate (Shotgun)": 0.2 } ],
       /* 6  */ [ 0, [ 4, 8 ], [ 4, 8 ], "Assault Adept", { "Weapon Schaden (Assault)": 0.12 } ],
       /* 7  */ [ 0, [ 4, 8 ], [ 4, 8 ], "Armorbreaker", { "Armor Piercing": 0.1 } ],
       /* 8  */ [ 0, [ 6, 7, 28 ], [ 6, 7, 9, 10, 11, 28 ], "Havoc", { "Weapon Schaden": 0.08 } ],
       /* 9  */ [ 0, [ 8 ], [], "Champion", { "Activating a Protection Skill increases Weapon Schaden by 45% for 10s": null } ],
       /* 10 */ [ 0, [ 8 ], [ 12 ], "Bull's Eye", { "Crit Schaden": 0.2 } ],
       /* 11 */ [ 0, [ 8 ], [ 12 ], "Steady Hands", { "Weapon Recoil": -0.3 } ],
       /* 12 */ [ 0, [ 10, 11 ], [ 13, 14, 15 ], "Havoc", { "Weapon Schaden": 0.08 } ],
       /* 13 */ [ 0, [ 12 ], [], "Assault Master", { "Weapon Schaden (Assault)": 0.2, "Drop Rate (Assault)": 0.2 } ],
       /* 14 */ [ 0, [ 12 ], [ 16 ], "Perpetual Motion", { "Skill Cooldown (Kinetic)": 0.15 } ],
       /* 15 */ [ 0, [ 12 ], [ 16 ], "Brawler", { "Weapon Schaden (Close Range)": 0.15 } ],
       /* 16 */ [ 0, [ 14, 15 ], [ 17, 19 ], "Havoc", { "Weapon Schaden": 0.08 } ],
       /* 17 */ [ 0, [ 16 ], [ 18 ], "Dry Them Out", { "Weapon Leech": 0.05 } ],
       /* 18 */ [ 0, [ 17 ], [], "Bounty Hunter", { "Schaden (Against Elites)": 0.15, "Schaden Taken (From Elites)": -0.15 } ],
       /* 19 */ [ 0, [ 16 ], [ 20, 21 ], "Bulletstorm", { "Reload Time": -0.2 } ],
       /* 20 */ [ 0, [ 19 ], [], "Ammo Stockpile", { "Magazine Size": 0.5 } ],
       /* 21 */ [ 0, [ 19 ], [ 22, 23 ], "Confrontation", { "Enemies who Schaden you will have their Physical Schaden reduced by 10% for 5s. This effect is doubled if you Schaden that Enemy": null } ],
       /* 22 */ [ 0, [ 21 ], [ 24 ], "Dry Them Out", { "Weapon Leech": 0.05 } ],
       /* 23 */ [ 0, [ 21 ], [ 24 ], "Armorbreaker", { "Armor Piercing": 0.1 } ],
       /* 24 */ [ 0, [ 22, 23 ], [], "Altered Charge", { "When your Kinetic Skill ends, increase Weapon Schaden by 70% for 10s": null } ],
      
       /* 25 */ [ 0, [ 4, 26 ], [ 4, 26 ], "Perpetual Motion", { "Skill Cooldown (Kinetic)": 0.15 } ],
       /* 26 */ [ 0, [ 25, 33 ], [ 25, 33, 27 ], "Into the Fray", { "When your Kinetic Skill ends, increase Schaden Mitigation by 15% for 10s": null } ],
       /* 27 */ [ 0, [ 26 ], [], "Vim and Vigor", { "Increase Weapon Schaden by 10% for each unlocked Anomaly in Veins node": null } ],
       ...
       /* 32 */ [ 0, [ 30, 33 ], [ 30, 33 ], "Anomaly in Veins", { "Leben Regen every second": 0.01 } ],
       /* 33 */ [ 0, [ 26, 31, 32, 34, 35, 50 ], [ 26, 31, 32, 34, 35, 50 ], "Colossus", { "Leben": 0.1 } ],
       /* 34 */ [ 0, [ 33, 36 ], [ 33, 36 ], "Resistance Paragon", { "Resistance": 0.2 } ],
       /* 35 */ [ 0, [ 33, 36 ], [ 33, 36 ], "Anomaly in Veins", { "Leben Regen every second": 0.01 } ],
       /* 36 */ [ 0, [ 28, 34, 35, 53 ], [ 28, 34, 35, 37, 38, 53 ], "Colossus", { "Leben": 0.1 } ],
       /* 37 */ [ 0, [ 36 ], [ 39 ], "Anomaly in Veins", { "Leben Regen every second": 0.01 } ],
       /* 38 */ [ 0, [ 36 ], [ 39 ], "Tank", { "Armor": 0.2 } ],
       /* 39 */ [ 0, [ 37, 38 ], [ 40, 41, 42 ], "Colossus", { "Leben": 0.1 } ],
       /* 40 */ [ 0, [ 39 ], [], "Outrider Commander", { "Increase all heilung and Shields by 20% for you and your allies": null } ],
       ...
       /* 44 */ [ 0, [ 43 ], [], "Unbroken Vow", { "You have 100% chance to ignore Schaden that would kill you and instantly heilt you for 50% of your maximale Lebenspunkte (180s cooldown)": null } ],
       ...
       /* 67 */ [ 0, [ 66 ], [], "Strong Arm of the Law", { "Melee Skill deals double Schaden": null } ],
       /* 68 */ [ 0, [ 66 ], [ 70 ], "Executioner", { "Increase Schaden by 20% against Enemies below 30% Leben": null } ],
       /* 69 */ [ 0, [ 66 ], [ 70 ], "Red Rivers", { "Bleed Duration": 0.3 } ],
       /* 70 */ [ 0, [ 68, 69 ], [ 71, 73 ], "Anomaly Resevoir", { "Anomaly Power": 0.06 } ],
       /* 71 */ [ 0, [ 70 ], [ 72 ], "Bloodbath", { "Bleed Schaden": 0.3 } ],
       /* 72 */ [ 0, [ 71 ], [], "Blood Donation", { "You are geheilt for 25% of the Schaden caused by Bleed": null } ],
       ...
       /* 77 */ [ 0, [ 75 ], [ 78 ], "Bloodbath", { "Bleed Schaden": 0.3 } ],
       /* 78 */ [ 0, [ 76, 77 ], [], "Earth's Heritage", { "Skill Schaden (Seismic)": 0.5 } ]
    ],
    
    technomant: [
       /* 0  */ [ 1, [], [ 1, 29, 55 ], "", { "Weapon Schaden (Long Range)": 0.15, "Skill Leech": 0.15, "Weapon Leech": 0.15 } ],
      
       /* 1  */ [ 0, [ 0, 2, 3 ], [ 2, 3 ], "Br/8 Impact Amplifier", { "Weapon Schaden": 0.08 } ],
       ...
       /* 5  */ [ 0, [ 4 ], [], "Sniper Master", { "Weapon Schaden (Sniper)": 0.2, "Drop Rate (Sniper)": 0.2 } ],
       ...
       /* 8  */ [ 0, [ 6, 7, 27 ], [ 6, 7, 9, 10, 11, 27 ], "Br/8 Impact Amplifier", { "Weapon Schaden": 0.08 } ],
       /* 9  */ [ 0, [ 8 ], [], "Cannonade", { "Activating an Ordinance Skill increases Weapon Schaden for you and your allies by 30% for 10s": null } ],
       /* 10 */ [ 0, [ 8 ], [ 12 ], "Nitrogen Capsules", { "Decrease the distance considered to be Long Range by 3m [2]": null } ],
       /* 11 */ [ 0, [ 8 ], [ 12 ], "Purge", { "Schaden (Against Toxic'ed)": 0.1 } ],
       /* 12 */ [ 0, [ 10, 11 ], [ 13, 14, 15 ], "Br/8 Impact Amplifier", { "Weapon Schaden": 0.08 } ],
       /* 13 */ [ 0, [ 12 ], [], "Assault Master", { "Weapon Schaden (Assault)": 0.2, "Drop Rate (Assault)": 0.2 } ],
       /* 14 */ [ 0, [ 12 ], [ 16 ], "Assault Adept", { "Weapon Schaden (Assault)": 0.12 } ],
       /* 15 */ [ 0, [ 12 ], [ 16 ], "Sniper Adept", { "Weapon Schaden (Sniper)": 0.12 } ],
       /* 16 */ [ 0, [ 14, 15 ], [ 17, 18 ], "Drill Coating", { "Armor Piercing": 0.1 } ],
       /* 17 */ [ 0, [ 16 ], [], "Two Sides of the Power", { "Schaden Taken": 0.15, "Schaden": 0.2 } ],
       /* 18 */ [ 0, [ 16 ], [ 19, 20 ], "Sharpshooter", { "Weapon Schaden (Long Range)": 0.3 } ],
       ...
       /* 21 */ [ 0, [ 20 ], [ 23 ], "Charged Gunshot", { "First shot after reloading deals +200% Schaden (5s cooldown)": null } ],
       /* 22 */ [ 0, [ 20 ], [ 23 ], "Purge", { "Schaden (Against Toxic'ed)": 0.15 } ],
       /* 23 */ [ 0, [ 21, 22 ], [], "Empowering Antena", { "Activating a Decay Skill increases Weapon Schaden for you and your allies by 40% for 10s": null } ],
      
       /* 24 */ [ 0, [ 4, 25 ], [ 4, 25 ], "BL-STM Havoc Nexus", { "Crit Schaden": 0.15 } ],
       ...
       /* 32 */ [ 0, [ 25, 30, 31, 33, 34, 51 ], [ 25, 30, 31, 33, 34, 51 ], "Anomalus Body", { "Leben": 0.1 } ],
       /* 33 */ [ 0, [ 32, 35 ], [ 32, 35 ], "Armor Plates", { "Armor": 0.2 } ],
       /* 34 */ [ 0, [ 32, 35 ], [ 32, 35 ], "Fracture", { "Schaden (Against Frozen)": 0.1 } ],
       /* 35 */ [ 0, [ 27, 33, 34, 54 ], [ 27, 33, 34, 36, 37, 54 ], "Anomalus Body", { "Leben": 0.1 } ],
       /* 36 */ [ 0, [ 35 ], [ 38 ], "Vitality Magnet", { "Skill Leech": 0.06 } ],
       /* 37 */ [ 0, [ 35 ], [ 38 ], "Gadgeteer", { "Skill Cooldown (Gadget)": 0.15 } ],
       /* 38 */ [ 0, [ 36, 37 ], [ 39, 40, 42, 43 ], "Anomalus Body", { "Leben": 0.1 } ],
       /* 39 */ [ 0, [ 38 ], [], "Senior Engineer", { "Increase Turrets Leben by 100%": null } ],
       ...
       /* 46 */ [ 0, [ 45 ], [], "Medical Unit", { "Activating a Gadget Skill increases all heilung received for you and your allies by 30% for 7s": null } ],
       ...
       /* 49 */ [ 0, [ 47 ], [ 50 ], "Fracture", { "Schaden (Against Frozen)": 0.3 } ],
       /* 50 */ [ 0, [ 48, 49 ], [], "Overclocked", { "Activating a Gadget Skill increases Weapon Schaden and Anomaly Power by 40% for 10s": null, "Upon losing all Leben you will receive a second chance to return to the battlefield with 50% maximale Lebenspunkte for 10s (180s cooldown)": null } ],
       
       /* 51 */ [ 0, [ 32, 53 ], [ 32, 52, 53 ], "Winter's Barrier", { "After using your Melee Skill, gain 40% Schaden Mitigation for 3s": null } ],
       /* 52 */ [ 0, [ 51 ], [], "Sols-56 Freezing Tanks", { "Freeze Duration": 0.2 } ],
       /* 53 */ [ 0, [ 51, 58 ], [ 51, 58 ], "Sidearm Adept", { "Weapon Schaden (Sidearm)": 0.12 } ],
       /* 54 */ [ 0, [ 35, 62 ], [ 35, 62 ], "Wipe Out", { "Increase Schaden by 20% against Enemies below 30% Leben": null } ],
       ...
       /* 61 */ [ 0, [ 58, 62 ], [ 58, 62 ], "Welcome Shot", { "First shot after reloading deals Schaden with Firepower increased by 15% of Anomaly Power": null } ],
       ...
       /* 69 */ [ 0, [ 66 ], [ 70 ], "D-Kay Toxin", { "Toxic Schaden": 0.2 } ],
       /* 70 */ [ 0, [ 68, 69 ], [ 71, 73 ], "Disturbance Coating", { "Resistance Piercing": 0.15 } ],
       /* 71 */ [ 0, [ 70 ], [ 72 ], "Vitality Magnet", { "Skill Leech": 0.06 } ],
       /* 72 */ [ 0, [ 71 ], [], "Emergency Transfusion", { "Doubles Skill Leech when Leben drops below 30%": null } ],
       ...
       /* 75 */ [ 0, [ 73 ], [ 76, 77 ], "Team Player", { "Decreases Elite's Schaden against you and your allies by 10%": null } ],
       /* 76 */ [ 0, [ 75 ], [ 78 ], "Anomally Fueled", { "Anomaly Power": 0.06 } ],
       /* 77 */ [ 0, [ 75 ], [ 78 ], "D-Kay Toxin", { "Toxic Schaden": 0.2 } ],
  ...
  let keywords = {
    ...
    "hl-d": /((weapon|assault|close range|long range) Schaden|firepower)/gi,
    "hl-e": /(weakness|vulnerab(le|ility)|marked|burn(ing)?|ash(ed)?|bleed|toxic|freeze|frozen)/gi,
    "hl-h": /((maximale )?Lebenspunkte|(maximalen )?Leben(s|spunkte)?)/gi,
    ...
    "hl-r": /((armor|resistance)(?!( and resistance)? piercing)|Schaden mitigation)/gi,
    "hl-s": /((Schaden|deception|movement|ignite|immobilize|explosive|protection|seismic|kinetic|decay|ordinance|gadget|melee|any) skills?|stone push|(?<=skill (cooldown|Schaden) \()(Schaden|deception|movement|ignite|immobilize|explosive|protection|seismic|kinetic|decay|ordinance|gadget|any))/gi,
  ...
  //--- Unique Node Skill Count
  $(".stat[data-s='Increase Assault Schaden by 3.5% for each unlocked Concentration node'] td").append(" (<span class=\"unique\" data-c=\"0\" data-v=\"0.035\">0%</span>)")
  ...
  $(".stat[data-s='Increase Weapon Schaden by 10% for each unlocked Anomaly in Veins node'] td").append(" (<span class=\"unique\" data-c=\"0\" data-v=\"0.1\">0%</span>)")
  ...
  let abilitydesc = {
    trickster: {
      ...
      "Venator's Knife": "Throw a temporal knife at an enemy. The blade will ricochet between a maximale Lebenspunkte of [Y] enemies within a small radius, dealing [Z] Schaden and marking them. All marked targets will be inflicted by Slow, and for [X] seconds the first Schaden dealt by you will be doubled.",
    ...
    pyromant: {
      "Thermal Bomb": "Select an enemy to Burn, Interrupt and deal ~13% Schaden to. If killed while still afflicted by the skill, the enemy will explode, dealing ~112% Schaden within a large radius.",
      "Overheat": "Deal ~3.7% Schaden to all enemies within a large radius and Interrupt their skills. Enemies afflicted with Burn receive ~45% Schaden instead (the Burn will be consumed).",
      "Eruption": "Create a volcanic eruption beneath the selected enemy, dealing [Z] Schaden to all enemies within a small radius of the target. The eruption spews lava, dealing Schaden over time within a small area.",
      "Heatwave": "Summon a fiery wave that deals ~17.5% Schaden and inflicts Burn onto all enemies in its path.",
      "Volcanic Rounds": "Fill your current weapon's magazine with bullets that will ignite the air around enemies and inflict Burn onto them, even if the bullet misses. If the bullet hits, it causes skill Schaden, ignoring armor and piercing the target, damaging others behind them. The skill lasts until you reload or switch weapons.",
      "F.A.S.E.R Beam": "Fire an energy beam that deals [Z] Schaden that benefits from [X]% of Status Power, inflicting Burn and causing Interrupt to enemies hit by the beam, as well as enemies within a small radius around you.",
      "Feed the Flames": "Select and pull an enemy towards you dealing ~25% Schaden, draining ~25% Leben, and inflicting Ash.",
      "Ash Blast": "Create an Anomaly blast to inflict Ash onto all enemies within a large radius around you.",
    },
    verwüster: {
      "Gravity Leap": "Leap into the air and strike your targets from above, dealing ~80% Schaden and Interrupting enemies within a small radius of the area you land in.",
      "Boulderdash": "Charge forward to Interrupt all enemies in your path and deal [Z] Schaden. At the end of the charge, you will smash the ground and deal [Z] Schaden to all enemies within a small radius around you.",
      "Endless Mass": "Select a target to encase in stone, inflicting Bleed and pulling enemies within a small radius towards the initial target. The stone will then explode, dealing [Z] Schaden to all enemies within a small radius around the target.",
      "Golem": "Fortify yourself against 65% of incoming Schaden for 8 seconds.",
      "Earthquake": "Release a shockwave to deal ~40% Schaden and Interrupt all enemies in front of you.",
      "Reflect Bullets": "Create a barrier that captures all enemy projectiles and accumulates Schaden. After 10 seconds of triggering the skill, the accumulated Schaden is reflected back to enemies in front of you.<br><br>The barrier also protects against melee attacks by reflecting some Schaden back.",
      "Impale": "Select a target to Interrupt their skills, inflict Bleed, and deal [Z] Schaden.<br><br>If the Schaden is lethal, the enemy will be impaled, granting a powerful bonus to Armor and Leben Regeneration to all allies for 9 seconds.",
      "Tremor": "Create a series of explosions around you, each dealing [Z] Schaden and draining [X] Leben from enemies within a medium radius around you.",
    },
    technomant: {
      "Blighted Rounds": "Fill your current weapon's magazine with decay-infused bullets that inflict Toxic onto enemies. Enemies within a small radius of the main target also receive Toxic and 50% of Schaden. The skill lasts until you reload or switch weapons.",
      "Blighted Turret": "Place an automated turret that deals [Z] Schaden and inflicts Toxic onto enemies. The turret's Leben depletes slowly over time and when it takes Schaden.",
      "Cryo Turret": "Place an automated turret that deals ~2% Schaden and inflicts Freeze onto enemies. The turret's Leben depletes slowly over time and when it takes Schaden.",
      "Fixing Wave": "Release your energy to restore [X]% of Leben to all players and [Y]% of Leben to your turrets, regardless of distance.",
      "Cold Snap": "Drop a gadget to inflict Freeze onto all enemies within a large radius around you.",
      "Scrapnel": "Throw a proximity mine. The explosion deals ~77% Schaden and Interrupts the skills of enemies caught within the blast radius.",
      "Pain Launcher": "Place a missile launcher and bomb the area in front of you. Each missile deals ~13% Schaden per hit and Interrupts enemy skills.",
      "Tool Of Destruction": "Press the skill button to equip a Rocket Launcher that can Interrupt enemies and deals [X] Schaden. Hold the skill button for a Minigun that deals [Z] Schaden per shot.<br><br>The skill will remain active until all ammo is depleted or until you switch weapons.",
    }
  }

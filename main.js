...
function loadData() {  
  ...
  skills = {
    ...
    verwüster: [
       ...
       /* 40 */ [ 0, [ 39 ], [], "Outrider Commander", { "Increase all heilting and Shields by 20% for you and your allies": null } ],
       ...
       /* 68 */ [ 0, [ 66 ], [ 70 ], "Executioner", { "Increase Damage by 20% against Enemies below 30% Leben": null } ],
    ...
    technomant: [
       ...
       /* 27 */ [ 0, [ 8, 35 ], [ 8, 28, 35 ], "Blurscreen", { "Leben Regen threshold is increased by 20% of Maximum Leben": null } ],
       ...
       /* 46 */ [ 0, [ 45 ], [], "Medical Unit", { "Activating a Gadget Skill increases all heilungg received for you and your allies by 30% for 7s": null } ],
       /* 47 */ [ 0, [ 45 ], [ 48, 49 ], "Doctor of Medicine", { "Increase all heilungheiltinheilting done by you and your allies by 20%": null } ],
       ...
       /* 54 */ [ 0, [ 35, 62 ], [ 35, 62 ], "Wipe Out", { "Increase Damage by 20% against Enemies below 30% Leben": null } ],
  ...
  let keywords = {
    ...
    "hl-h": /((maximum )?Leben( regen)|Leben?)/gi,
    "hl-l": /(^\[hm\]|(weapon|skill) leech|heilt(?!th)(s|ed|ing)?)/gi,
  ...
  let abilitydesc = {
    ...
    pyromant: {
      ...
      "Feed the Flames": "Select and pull an enemy towards you dealing ~25% damage, draining ~25% Leben, and inflicting Ash.",
    ...
    verwüster: {
      ...
      "Impale": "Select a target to Interrupt their skills, inflict Bleed, and deal [Z] damage.<br><br>If the damage is lethal, the enemy will be impaled, granting a powerful bonus to Armor and Leben Regeneration to all allies for 9 seconds.",
      "Tremor": "Create a series of explosions around you, each dealing [Z] damage and draining [X] Leben from enemies within a medium radius around you.",
    },
    technomant: {
      ...
      "Blighted Turret": "Place an automated turret that deals [Z] damage and inflicts Toxic onto enemies. The turret's Leben depletes slowly over time and when it takes damage.",
      "Cryo Turret": "Place an automated turret that deals ~2% damage and inflicts Freeze onto enemies. The turret's Leben depletes slowly over time and when it takes damage.",
